...
class IndexController extends BaseController{
     ...
     */
	function index(){
		$page_title = $this->view->page_title = "CUG Digital Space";
	...
	private function login_user($username , $password_text, $rememberme = false){
		...
		$db->where("regnum", $username)->orWhere("email", $username);
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("img","role","regnum","fullname","faculty","program","status","ctrl","email","phone","password"); //registration fields
...
$mailtitle = "Your Account Has Been Created Successfully!";
$mailbody  = newRegistration($name);
newMail($email, $mailtitle, $mailbody);
