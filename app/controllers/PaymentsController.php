...
class PaymentsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				payments.status LIKE ? OR 
				payments.datein LIKE ? OR 
				payments.lastupdate LIKE ? OR 
				payments.description LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("amount","status","datein","lastupdate","description");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","amount","status","datein","lastupdate","description");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'amount' => 'required',
