...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php print_link('assets/swiper-10.3.1/package/swiper.min.css');?>"/>
		<?php 
	...
	<body id="<?php echo $page_id ?>" class="with-login <?php echo $body_class ?>">
		...
		<script src="<?php print_link('assets/swiper-10.3.1/package/swiper-bundle.min.js');?>"></script>
		<?php
            include COMPS.'navs/bottom.php';
            include COMPS.'modals.php';
            html ::  page_js('navigator.js');
            html ::  page_js('main.js');
			Html ::  page_js('ion.rangeSlider.min.js');
			Html ::  page_js('loading-bar.js');
