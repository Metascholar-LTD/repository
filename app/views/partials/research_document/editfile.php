            ...
            <div class="row justify-content-center">
                <div class="col-md-10 p-5 shadow-sm border comp-grid curve form-bg">
                    ...
                    <div  class="ui-form animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("research_document/editfile/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
