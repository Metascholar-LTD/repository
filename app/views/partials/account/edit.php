    ...
    <div  class="">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 p-5 form-bg shadow-lg border curve accountP comp-grid">
                    <?php $this :: display_page_errors(); ?>
                    <div  class="ui-form animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("account/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-regnum-holder" class=""> 
                                            <input id="ctrl-regnum"  value="<?php  echo $data['regnum']; ?>" type="text" placeholder="Enter Regnum"  required="" name="regnum"  data-url="api/json/account_regnum_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
