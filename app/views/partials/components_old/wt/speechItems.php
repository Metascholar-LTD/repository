        ...
        <table class="table table-hover">
            <tbody class="pageRecords page-records">
                ...
                <tr>
                    ...
                    <td style="width:70px;">
                        <img src="<?= print_link(IMG_DIR.'messages alt.png'); ?>" alt=" paper thumb" width="40px"> 
                    </td>
                    <td>
                    ...
                    <td><?=human_date($item['issue_date'])?></td>
                    <td><a class="text-primary page-modal" href="<?php print_link('speech/view/'.$item['id']);?>">Preview</a></td>
                </tr>
                <?php } ?>
