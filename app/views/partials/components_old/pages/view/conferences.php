            ...
            <div class="col-lg col-12">
                ...
                <div class="mb-5">
                    <div class="row justify-content-center">
                        <div class="col">
                            <div class="mb-3 card border-gold active shadow-0 border border-2 py-3">
                                <div class="mb-3">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <th class="px-3 text-md text-black">Publisher</th>
                                        <td><a class="text-black"><?=$data['publisher']?></a></td>
                                    </tr>
                                    <tr>
                                        <th class="px-3 text-md text-black">Issue Date</th>
                                        <td><a class="text-black"><?=human_date($data['issue_date'])?></a></td>
                                    </tr>
                                ...
                                <div class="p-3">
                                    ...
                                    foreach(explode(',',$url) as $file) { $i++;?>
                                        <button class="btn bg-black text-white mb-1" onclick="downloadFile('conferences',<?=$data['id']?>, $(this), <?=($i-1)?>)">
                                            <i class="pi pi-download text-warning"></i> Download Partition <?=$i?>
                                        </button>
                                    <?php } } ?>
                                </div>
                            </div>
