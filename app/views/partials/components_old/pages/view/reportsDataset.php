            ...
            <div class="col-lg col-12">
                ...
                <div class="mb-5">
                    <div class="row justify-content-center">
                        <div class="col">
                            <div class="mb-3 card hover-success active shadow-0 border border-2 py-3">
                                <div class="mb-3">
                                ...
                                <div class="p-3">
                                    ...
                                    foreach(explode(',',$url) as $file) { $i++;?>
                                        <button class="btn bg-black text-white mb-1" onclick="downloadFile('reports_dataset',<?=$data['id']?>, $(this), <?=($i-1)?>)">
