...
if(strtolower(USER_ROLE) != 'super admin'){
    $superAdminItems = [[],[],[],[]]; 
}
$navItems = [
...
?>
<div id="left-nav">
    <?php if(strtolower(USER_ROLE) == 'super admin' || strtolower(USER_ROLE) == 'admin'){?>
    <div class="wrapper">
        <div class="bg-white relative">
           <div class="px-3 bg-white centeredL text-nowrap" style="height:80px;">
                <div class="centeredL">
                    <img src="<?php print_link(set_img_src(SITE_LOGO,35))?>" alt=""/>
                    <div class="menu-label">
                        <div class="bold text-black font2"><?=strtoupper('Catholic')?></div>
                        <div class="small">
    ...
    <div class="sidebar-modal-holder">
        ...
        <div class="modal-item scroll-y p-3" item="menu">
            <h2 class="mb-3 bold text-black"><?='App Menu'?></h2>
        ...
        <div class="modal-item scroll-y p-3" item="upload">
            <?php 
            if(strtolower(USER_ROLE) == 'super admin'){include "superAdminUploadOptions.php";}
            else if(strtolower(USER_ROLE) == 'admin'){include "adminUploadOptions.php";}
            else if(strtolower(USER_ROLE) == 'staff'){include "staffUploadOptions.php";}
