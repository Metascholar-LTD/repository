...
$can_add = ACL::is_allowed("settings/add");
$can_edit = ACL::is_allowed("settings/edit");
$can_view = ACL::is_allowed("settings/view");
$can_delete = ACL::is_allowed("settings/delete");
?>
<?php
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-slab">
                                        <th class="title"> Slab: </th>
                                        <td class="value"> <?php echo $data['slab']; ?></td>
                                    </tr>
                                    <tr  class="td-sval">
                                        <th class="title"> Sval: </th>
                                        <td class="value"> <?php echo $data['sval']; ?></td>
                                    </tr>
                                    <tr  class="td-state">
                                        <th class="title"> State: </th>
                                        <td class="value"> <?php echo $data['state']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
