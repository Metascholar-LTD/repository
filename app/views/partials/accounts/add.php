...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Accounts</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="accounts-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("accounts/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-role-holder" class=""> 
                                            <select required=""  id="ctrl-role" name="role"  placeholder="Select a value ..."    class="custom-select" >
                                                ...
                                                $value = $option['value'];
                                                $label = $option['label'];
                                                $selected = $this->set_field_selected('role', $value, "student");
                                                ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-regnum-holder" class=""> 
                                            <input id="ctrl-regnum"  value="<?php  echo $this->set_field_value('regnum',""); ?>" type="text" placeholder="Enter Regnum"  required="" name="regnum"  data-url="api/json/accounts_regnum_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-fullname-holder" class=""> 
                                                <textarea placeholder="Enter Fullname" id="ctrl-fullname"  required="" rows="2" name="fullname" class=" form-control"><?php  echo $this->set_field_value('fullname',""); ?></textarea>
