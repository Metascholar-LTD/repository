...
define("APP_ID", "49b97af0741836eb2b4adcc14e03bf3d");
...
define("COMPS", "app/views/partials/components/");
define("MAKEUPS", "app/views/partials/components/makeup/");
define("UTILS", "app/views/partials/components/utils/");
define("FORMS", "app/views/partials/components/forms/");
...
define("SMTP_USERNAME", "cug@academicdigital.space");
define("SMTP_PASSWORD", "Catholic@2020");
define("SMTP_HOST", "smtp.titan.email");
define("SMTP_PORT", "465");

//Default Email Sender Details. Please set this even if you are not using SMTP
define("DEFAULT_EMAIL", "cug@academicdigital.space");
define("DEFAULT_EMAIL_ACCOUNT_NAME", "Catholic University of Ghana");

// Database Configuration Settings
define("DB_HOST", "localhost");
define("DB_USERNAME", "u377936951_cugrepository");
define("DB_PASSWORD", "Catholic@1997");
define("DB_NAME", "u377936951_cugrepository");
...
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['regnum'] : null ));
