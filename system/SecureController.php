...
class SecureController extends BaseController{
	function __construct(){
		...
		$exclude_pages = array('research_document/list', 'lecture_notes/list', 'ebooks/list', 'reports_dataset/list', 'past_questions/list', 'academic_calendar/list', 'conferences/list', 'speech/list', 'research_article/list', 'research_document/view', 'explore/list', 'team/list', 'research_document/sm', 'lecture_notes/view', 'ebooks/view', 'reports_dataset/view', 'past_questions/view', 'academic_calendar/view', 'conferences/view', 'speech/view', 'research_article/view', 'research_article/sm');
		$url = Router :: $page_url;
