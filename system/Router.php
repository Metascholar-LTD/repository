...
class Router
{
	...
	function run($url)
	{
		...
		$fieldname = filter_var($fieldname, FILTER_SANITIZE_SPECIAL_CHARS);
		$fieldvalue = filter_var($fieldvalue, FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$args = filter_var_array($args, FILTER_SANITIZE_SPECIAL_CHARS);
